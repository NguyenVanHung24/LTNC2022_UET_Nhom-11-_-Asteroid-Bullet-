...
int main(int argc, char* args[])
{
	...
	gMusic = Mix_LoadMUS("music/Mercury.ogg");
	// sound effect
	Mix_Chunk* player_fire = NULL;
	Mix_Chunk* enemy_die = NULL;
	player_fire = Mix_LoadWAV("sound/player_fire.ogg");
	enemy_die = Mix_LoadWAV("sound/shotgun.ogg");
	if (gMusic == NULL)
	{
	...
	//get texture
	SDL_Texture* background = window.loadTexture("image/aka.png");
	SDL_Texture* pilot = window.loadTexture("image/newplayer.png");
	SDL_Texture* pow = window.loadTexture("image/playerBullet.png");
	SDL_Texture* p_enemy = window.loadTexture("image/enemy.png");
	SDL_Texture* pow_enemy = window.loadTexture("image/enemyBullet.png");
	SDL_Texture* explode = window.loadTexture("image/spritesheet.png");
	SDL_Texture* backgroungimage = window.loadTexture("image/menubgr1.png");
	SDL_Texture* highscore = window.loadTexture("image/highscore.png");
	SDL_Texture* square = window.loadTexture("image/square.png");
	SDL_Texture* button = window.loadTexture("image/button.png");
	SDL_Texture* bar = window.loadTexture("image/scorebar.png");
	SDL_Texture* menubgr = window.loadTexture("image/akabgr.png");
	SDL_Texture* aboutscreen = window.loadTexture("image/aboutscreen.png");
	SDL_Texture* gameover = window.loadTexture("image/gameover.png");
	...
	//init boss
	SDL_Texture* boss = window.loadTexture("image/boss.png");
	enemy Boss(boss);
	Boss.mCollider.x = -1000;
	Boss.mCollider.y = -1000;

	//init bonus
	SDL_Texture* bonuspic = window.loadTexture("image/bonus.png");
	...
	SDL_Texture* boss_bull = window.loadTexture("image/biglaser.png");
